...
kitti_org_train["cal"] = os.path.join(
    curr_folder, "training_org", "replace", "calib"
)
kitti_org_train["ims"] = os.path.join(
    curr_folder, "training_org", "replace", "image_0"
)
kitti_org_train["lab"] = os.path.join(
    curr_folder, "training_org", "replace", "label_0"
)
...
kitti_org_val = dict()
kitti_org_val["cal"] = os.path.join(
    curr_folder, "validation_org", "replace", "calib"
)
kitti_org_val["ims"] = os.path.join(
    curr_folder, "validation_org", "replace", "image_0"
)
kitti_org_val["lab"] = os.path.join(
    curr_folder, "validation_org", "replace", "label_0"
)
...
for line in text_lines:
    ...
    if parsed is not None:
        ...
        org_calib_path = os.path.join(
            kitti_org_train["cal"].replace("replace", seg), id + ".txt"
        )
        org_label_path = os.path.join(
            kitti_org_train["lab"].replace("replace", seg), id + ".txt"
        )
        org_image_path = os.path.join(
            kitti_org_train["ims"].replace("replace", seg), id + ".png"
        )
...
for line in text_lines:
    ...
    if parsed is not None:
        ...
        org_calib_path = os.path.join(
            kitti_org_val["cal"].replace("replace", seg), id + ".txt"
        )
        org_label_path = os.path.join(
            kitti_org_val["lab"].replace("replace", seg), id + ".txt"
        )
        org_image_path = os.path.join(
            kitti_org_val["ims"].replace("replace", seg), id + ".png"
        )
