...
from deviant.lib.helpers.util import is_slanted
...
ego_height = 1.65
slant_cnt, tot_cnt = get_slanted_images_cnt(
    label_folder, ego_height=ego_height
)
...
label_folder = (
    "/media/abhinav/baap/abhinav/datasets/nusc_kitti_front/val/label_2"
)
ego_height = 1.56
slant_cnt, tot_cnt = get_slanted_images_cnt(
    label_folder, ego_height=ego_height
