...
if platform.system() == "Linux":
    from display2D import (
        Display2D,
    )  #  !NOTE: pygame generate troubles under macOS!
...
if __name__ == "__main__":
    ...
    img_id = (
        0  # 180, 340, 400   # you can start from a desired frame id if needed
    )
    while dataset.isOk():
        if not is_paused:
            print("..................................")
                ...
                if matched_points_plt is not None:
                    ...
                    if slam.tracking.num_matched_map_points is not None:
                        valid_matched_map_points_signal = [
                            img_id,
                            slam.tracking.num_matched_map_points,
                    ...
                    if slam.tracking.num_kf_ref_tracked_points is not None:
                        kf_ref_tracked_points_signal = [
                            img_id,
                            slam.tracking.num_kf_ref_tracked_points,
                        ]
                        matched_points_plt.draw(
                            kf_ref_tracked_points_signal,
                            "# $KF_{ref}$  tracked pts",
                    ...
                    if slam.tracking.descriptor_distance_sigma is not None:
                        descriptor_sigma_signal = [
                            img_id,
                            slam.tracking.descriptor_distance_sigma,
                        ]
                        matched_points_plt.draw(
                            descriptor_sigma_signal,
