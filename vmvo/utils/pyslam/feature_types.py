...
class FeatureInfo(object):
    ...
    max_descriptor_distance[
        FeatureDescriptorTypes.SUPERPOINT
    ] = 1.30  # SUPERPOINT
    #
    ...
    max_descriptor_distance[
        FeatureDescriptorTypes.BOOST_DESC
    ] = 100  # BOOST_DESC
    #
    ...
    #
    norm_type[
        FeatureDescriptorTypes.GEODESC
    ] = cv2.NORM_L2  # unless GeodescFeature2D.quantize == True
    ...
    #
    norm_type[
        FeatureDescriptorTypes.CONTEXTDESC
    ] = cv2.NORM_L2  # unless ContextDescFeature2D.quantize == True
    max_descriptor_distance[
        FeatureDescriptorTypes.CONTEXTDESC
    ] = 1.6  # CONTEXTDESC
    #
